    ...
    return (
        <nav className="content-navbar">
            ...
            <div className="content-mobile-menu">
                {!toggleMenu && (
                 <HiMenuAlt4 className="icons-menu-mobile" onClick={() => setToggleMenu(true)} />
                )}
                {toggleMenu && (
                <AiOutlineClose className="icons-menu-mobile" onClick={() => setToggleMenu(false)} />)}
                
                {toggleMenu && (
                    <ul className="background-menu-mobile">
